...
//    }
    ...
    public Connection getConnection() {
        Connection con = null;
        try {
            con = DriverManager.getConnection("jdbc:mysql://localhost:3306/ebookstore", "root", "");
        } catch (SQLException ex) {
...
//                String updatedDate = rs.getTimestamp("updatedDate").toString();
    ...
    private void Test(ResultSet rs, int searchYear) throws SQLException {
    ...
    private void Testing1(ResultSet rs) throws SQLException {
        while (rs.next()) {
            int BookId = rs.getInt("BookId");
//                int CatID = rs.getInt("CatID");
            String Name = rs.getNString("Name");
...
//                String updatedDate = rs.getTimestamp("updatedDate").toString();
    ...
    private void Testing(ResultSet rs) throws SQLException {
